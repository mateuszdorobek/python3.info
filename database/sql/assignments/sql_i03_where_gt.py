...
English:
    1. Write SQL query to select data:
       ...
       c. where: date is later than July 21st, 1969 (exclusive)
       d. use: >
...
Polish:
    1. Napisz zapytanie SQL aby wybrać dane:
       ...
       c. gdzie: data jest późniejsza niż 21 lipca 1969 (rozłącznie)
       d. użyj: >
...
# - where: date is later than July 21st, 1969 (exclusive)
# - use: >
# type: str
result = """
